...
void send_control_signals(int section_channel,
                          int section_pwm) {
  uint16_t spi_message = 0;
  switch (section_channel) {
    case 0:
      spi_message |= SECTION_0_CHANNEL_0;
      spi_message &= ~SECTION_0_CHANNEL_1;
      TIM2->CCR3 = section_pwm;
      break;
    case 1:
      spi_message &= ~SECTION_0_CHANNEL_0;
      spi_message |= SECTION_0_CHANNEL_1;
      ...
      break;
    case 2:
      spi_message |= SECTION_1_CHANNEL_0;
      spi_message &= ~SECTION_1_CHANNEL_1;
      TIM2->CCR4 = section_pwm;
      break;
    case 3:
      spi_message &= ~SECTION_1_CHANNEL_0;
      spi_message |= SECTION_1_CHANNEL_1;
      ...
      break;
    case 4:
      spi_message |= SECTION_2_CHANNEL_0;
      spi_message &= ~SECTION_2_CHANNEL_1;
      TIM3->CCR1 = section_pwm;
      break;
    case 5:
      spi_message &= ~SECTION_2_CHANNEL_0;
      spi_message |= SECTION_2_CHANNEL_1;
      ...
      break;
    case 6:
      spi_message |= SECTION_3_CHANNEL_0;
      spi_message &= ~SECTION_3_CHANNEL_1;
      TIM3->CCR2 = section_pwm;
      break;
    case 7:
      spi_message &= ~SECTION_3_CHANNEL_0;
      spi_message |= SECTION_3_CHANNEL_1;
      ...
      break;
    case 8:
      spi_message |= SECTION_4_CHANNEL_0;
      spi_message &= ~SECTION_4_CHANNEL_1;
      TIM3->CCR3 = section_pwm;
      break;
    case 9:
      spi_message &= ~SECTION_4_CHANNEL_0;
      spi_message |= SECTION_4_CHANNEL_1;
      ...
      break;
    case 10:
      spi_message |= SECTION_5_CHANNEL_0;
      spi_message &= ~SECTION_5_CHANNEL_1;
      TIM3->CCR4 = section_pwm;
      break;
    case 11:
      spi_message &= ~SECTION_5_CHANNEL_0;
      spi_message |= SECTION_5_CHANNEL_1;
  ...
  transfer_16b_SPI2_Master(spi_message);
}

void parse_section_pwm_and_channel_from_uart_buffer(int* section_channel,
                                                    int* section_pwm) {
  int tmp = atoi(control_message[0]);
 
  int JoysticLeftXAxis = control_message[0];//0..255 0-1 channel 
  int JoysticLeftYAxis = control_message[1];// 2-3 
  int JoysticRightXAxis = control_message[2];// 4 - 5
  int JoysticRightYAxis = control_message[3];// 6 - 7
  int button1State = control_message[4];//0 - pressed, >1 - not pressed
  int button2State = control_message[5];
  
  if (JoysticLeftXAxis > 125) {
    pwm_array[]
  }
  
  
  *section_pwm = JoysticLeftXAxis * 78;
  *section_channel = 0;
}
...
int main(void)
{
  ...
  while(1)
  {
    if (isControlMessageReceived) {
      int section_pwm = 0;
      int section_channel = 0;
      parse_section_pwm_and_channel_from_uart_buffer(&section_channel, &section_pwm); 
      
      send_control_signals(section_channel, section_pwm);
