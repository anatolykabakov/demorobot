...
int main(void)
{
  ...
  DelayMs(6000);
    ...
    while (1)
    {
      ...
      //send_Uart(USART3, ADC_values[1]);
      //lcd16x2_putc(getch_Uart(USART3));
      //lcd16x2_puts("UART=");
      //lcd16x2_putc(getch_Uart(USART3));
      ...
      //ValueStr(ADC_values[1]);
      send_Uart(USART3, Norm(ADC_values[1]));
      
      
        lcd16x2_puts("PB0=");
        ValueStr(ADC_values[3]);
        ...
        lcd16x2_puts("PA7=");
        ValueStr(ADC_values[2]);
        lcd16x2_putc(value[0]);
        lcd16x2_putc(value[1]);
        lcd16x2_putc(value[2]);
        
        lcd16x2_puts(" PA5=");
        ValueStr(ADC_values[4]);
        lcd16x2_putc(value[0]);
        lcd16x2_putc(value[1]);
        lcd16x2_putc(value[2]);
